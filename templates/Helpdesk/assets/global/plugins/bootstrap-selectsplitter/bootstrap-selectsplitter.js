+function ($) {
  'use strict';
    ...
    SelectSplitter.prototype.init = function (type, element, options) {
        ...
        self.$wrapper = self.$element.next('div[data-selectsplitter-wrapper-selector]'); // improved by Cadonix
        self.$firstSelect = $('select[data-selectsplitter-firstselect-selector]', self.$wrapper); // improved by Cadonix
        self.$secondSelect = $('select[data-selectsplitter-secondselect-selector]', self.$wrapper); // improved by Cadonix
