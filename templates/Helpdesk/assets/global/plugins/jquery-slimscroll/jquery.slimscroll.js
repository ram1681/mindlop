 ...
 *
 * Improved by Cadonix for Helpdesk Theme
 * Version: 1.3.2
 *
 */
(function($) {
    ...
    jQuery.fn.extend({
        slimScroll: function(options) {
            ...
            var defaults = {
                ...
                // sets animation status on a given scroll(added my Cadonix)
                animate: true
            };
            ...
            this.each(function() {
                ...
                //begin: windows phone fix added by Cadonix
                if ('ontouchstart' in window && window.navigator.msPointerEnabled) {
                  me.css("-ms-touch-action", "none");
              }
                //end: windows phone fix added by Cadonix
